...
<?php
// PRC ADDED SEARCH INDICATOR 6/2019
?>
<div class="avl-search-indicator alert alert-info text-center<?php if(tribe_get_request_var('tribe-bar-search')): ?> avl-search-indicator--active<?php endif; ?>">
	<?php
		$title_vals = array('Events', 'Upcoming');
		$title_replacements = array('events', 'upcoming'); 
		$revised_title = 'in '.str_replace($title_vals, $title_replacements, tribe_get_events_title());
	?>	
	<span class="search-text">
		<?php if(!tribe_get_request_var('tribe-bar-search')): ?>
			All events 
			<?php tribe_get_request_var('tribe-bar-search'); ?>
		<?php else: ?>
			Search results for "<?php echo tribe_get_request_var('tribe-bar-search') ?>"
		<?php endif; ?>
	</span>
	<span class="date-title">
		<?php echo $revised_title; ?>
	</span>
</div>
<?php
// END PRC ADDED SEARCH INDICATOR 6/2019
?>
<?php
