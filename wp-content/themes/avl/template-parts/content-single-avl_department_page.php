...
<article id="post-<?php the_ID(); ?>" <?php post_class('mb-5'); ?>>
	...
	<div class="entry-content">
		...
		if (strlen($content) === 0 || is_null($content)) {
			echo '<p>We\'re still working on the content for this page.  In the meantime, please <a href="#addsearch-input">search</a> or <a href="http://legacy.ashevillenc.gov" target="_blank" rel="noopener noreferrer">visit</a> the old site.</p>';
		}
